...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `1.0ms` | `7.0ms` |
| [Day 2](./src/bin/02.rs) | `2.0ms` | `2.0ms` |
| [Day 3](./src/bin/03.rs) | `4.4ms` | `4.6ms` |
| [Day 4](./src/bin/04.rs) | `4.9ms` | `5.2ms` |
| [Day 5](./src/bin/05.rs) | `260.4µs` | `28.2s` |
| [Day 6](./src/bin/06.rs) | `3.4µs` | `264.7ms` |
| [Day 7](./src/bin/07.rs) | `15.8ms` | `7.0s` |
| [Day 8](./src/bin/08.rs) | `2.7ms` | `16.8ms` |
| [Day 9](./src/bin/09.rs) | `1.9ms` | `1.7ms` |
| [Day 10](./src/bin/10.rs) | `387.9ms` | `6.9s` |
| [Day 11](./src/bin/11.rs) | `22.5ms` | `18.6ms` |
| [Day 12](./src/bin/12.rs) | `8.5s` | `24.8ms` |
| [Day 13](./src/bin/13.rs) | `2.4ms` | `529.1ms` |
| [Day 14](./src/bin/14.rs) | `507.2µs` | `2.3s` |
| [Day 15](./src/bin/15.rs) | `355.1µs` | `5.3ms` |
| [Day 16](./src/bin/16.rs) | `7.9ms` | `1.4s` |
