...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `226.9µs` | `1.5ms` |
| [Day 2](./src/bin/02.rs) | `424.4µs` | `430.9µs` |
| [Day 3](./src/bin/03.rs) | `929.4µs` | `1.0ms` |
| [Day 5](./src/bin/05.rs) | `55.2µs` | `7.3s` |
| [Day 6](./src/bin/06.rs) | `820.0ns` | `63.0ms` |
| [Day 7](./src/bin/07.rs) | `4.0ms` | `1.9s` |
